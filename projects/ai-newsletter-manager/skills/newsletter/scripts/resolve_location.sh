#!/usr/bin/env bash
# resolve_location.sh — Resolve a location shorthand to a GHL locationId.
#
...
#
# Output: prints the resolved locationId to stdout
...
# If no locations.json, fall back to env var
...
# If no --location given, use the default key
